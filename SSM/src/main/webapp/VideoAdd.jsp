...
<nav class="navbar-inverse">
	...
	<div class="container" style="margin-top: 20px;">
		...
		<form action="videoadd" id="infoForm" class="form-horizontal"  method="post" >
       ...
       <div class="form-group">
			...
			<div class="form-group">
			    ...
			    <div class="col-sm-10">
					...
					<select name="course_id" id="subjectId" class="form-control">
						<!--value=""  -->
						<option  selected="selected">请选择所属学科</option>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" name="time" id="subjectTitle" placeholder="视频时长" type="text">
				</div>
			</div>
			<!-- <div class="form-group">
