...
<nav class="navbar-inverse">
	...
	<div class="container" style="margin-top: 20px;">
		...
		<form action="speakeradd" id="infoForm" class="form-horizontal"  method="post" >
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" name="head_img_url" id="subjectTitle" placeholder="课程标题" type="text">
				</div>
			</div>
			<div class="form-group">
