...
<header>
                ...
                <div class="proflle_tab_body">
                    <div class="proflle_tab_workplace clearfix">
                        <div class="profile_avatar_area">
                                 ...
                                 <img src="${userimg2  }" width="200px;">
                           <!--  <img alt="" src=""> ${userimg2  }   -->

                            
                        </div>
                        <div class="profile_ifo_area">
                            <form action="userupdateZ">
 ...
 <c:if test="${selectsex=='' }">
<input id="man" name="sex" value="男"  type="radio" ><label for="man"  >男</label>
 <input id="woman" name="sex" value="女" type="radio"><label for="woman">女</label>
</c:if>        
<c:if test="${selectsex=='男'}">
<input type="radio" name="sex" checked="checked" value="男"/>男
<input type="radio" name="sex" value="女"/>女
</c:if>

<c:if test="${selectsex=='女'}">
<input type="radio" name="sex" value="男"/>男
<input type="radio" name="sex" checked="checked" value="女"/>女
</c:if>
                            <!-- <input id="man" name="sex" value="1"  type="radio" ><label for="man"  >男</label>
                                    <input id="woman" name="sex" value="女" type="radio"><label for="woman">女</label> -->
